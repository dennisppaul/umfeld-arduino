...
- [ ] @umfeld ==rename `loop` to `update` to comply with processing naming ( of `loop()` `noLoop()` )==
...
- [ ] @umfeld @example add nice stroke example with rotierender box, square, open-closed-shape + linen im 0.5,0.85,1.0 style
...
- [ ] @umfeld add llm support with ollama see https://chatgpt.com/share/67da673d-56cc-8004-bcd2-3ece7ec1c260
    ```C
    #include <iostream>
    #include <string>
    #include <curl/curl.h>
...
- [ ] @umfeld design neon font ![](IMG_3102.jpeg)
