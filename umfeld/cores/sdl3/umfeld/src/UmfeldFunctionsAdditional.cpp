...
namespace umfeld {
    ...
    void audio(const int input_channels,
        ...
        umfeld::input_channels         = input_channels;
        umfeld::output_channels        = output_channels;
        umfeld::sample_rate            = sample_rate;
